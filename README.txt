...
el script devielve en la variable la lista de organizaciones accesibles por la APY Key
...
el script se ejcura cada 5 minutos y actualiza la lista del archivo .csv
